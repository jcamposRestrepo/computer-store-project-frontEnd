...
export default function WhatsAppButton({ 
  phoneNumber = "573118993888", // Número por defecto (Colombia)
  message = "Hola! Me interesa conocer más sobre sus productos de computación." 
}: WhatsAppButtonProps) {
  ...
  return (
    <div className="fixed bottom-6 right-6 z-50">
      ...
      <button
        ...
        className="group relative bg-green-500 hover:bg-green-600 text-white p-4 rounded-full shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-110 animate-pulse-glow"
